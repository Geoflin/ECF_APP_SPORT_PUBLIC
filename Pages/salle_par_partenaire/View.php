...
<?php
if ($_SESSION['username'] == $password_admin['username']  && MD5($_SESSION['password']) == MD5($password) || $_SESSION['username'] == $dataCompte2['client_name']  && $_SESSION['password'] == $dataCompte2['password'] && $dataCompte2['actif']=='1' || $_SESSION['username_structure'] == $structure['Nom']  && $_SESSION['password_structure'] == $structure['password']) {
?>
